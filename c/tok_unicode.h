...
/* \p{M} — combining marks (Mn/Mc/Me). The cl100k pre-tokenizer does not need this; the
 * qwen35 one does, because its letter run is [\p{L}\p{M}]+ and not \p{L}+. Without it a
 * Devanagari or Arabic word splits at every diacritic. */
